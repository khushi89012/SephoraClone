...
export const Slider2 = () => {
  ...
  return (
    ...
    <div style={{display:"flex", textAlign:"center",marginTop:"1%",width:"82%",margin:"auto",justifyContent:"space-between"}}>
    <div style={{
        width:"53%"
...
>
    {makeupData.map((e,i)=>
    (
  <SliderDiv> <img id='image1' width="85%" src={e.image_url} alt="" />
