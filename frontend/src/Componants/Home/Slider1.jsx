...
<div id='divimage'>
  {
    ...
    (
      <div key={i}>
  <img src={e} alt="" width="180px" height="70px"/>
  </div>
    ))
  }
</div>
<br /> <br />
    ...
    <br />
    <div>
      <img width="83%" src="https://logan.nnnow.com/content/dam/nnnow-project/21-april-2022/HPBanner-Desktop.jpg" alt="" />
    </div>
<br />
    <div id='div2Image'>
      {div2Image.map((e,i)=>
      (
        <div key={i}>
          <img src={e} alt="" width="300px"height="300px" />
        </div>
      ))}
    </div>
   <br />
